return {
    ...
    config = function()
        ...
        require("mason-lspconfig").setup({
            ensure_installed = {
                "bashls", "bicep", "cmake", "docker_compose_language_service",
                "eslint", "gopls", "html", "htmx", "jsonls",
                "kotlin_language_server", "lua_ls", "powershell_es", "pylsp",
                "ruby_ls", "rust_analyzer", "tailwindcss", "terraformls",
